...
public class Sql {
	...
	public static final String GET_TRAININGS_BY_UNIT = "select t.id as id, t.title as title, e.id as trainerId, e.name as trainer,t.datetime as dateTime from employee e inner join training t on e.id=t.trainer_id  where e.unit_id=?";
